...
const Events = () => {
  ...
  const { ref: myref6, inView: boxisvisible6, entry6 } = useInView();
      ...
      <div className={styles.container_2}>
        <section className={styles.timeline}>
          ...
          <section className={styles.space}>
            ...
            <div
              ref={myref6}
              className={`${styles.box} ${boxisvisible6 ? styles.inView : ""}`}
            >
              <Link to="/Events/2024" className={styles.link_box}>
                ...
                <div className={styles.part2}>
                  <h3 className={styles.heading}>TEDxIITGuwahati 2024</h3>
                  <div className={styles.dis}>
                  The theme for TEDxIITGuwahati 2024 is Echoes of Stillness.
                  What’s that? It’s about fathoming the importance of taking break in process of reaching our goals.
                  </div>
                </div>
            ...
            <div className={styles.dateWrapper}>
              <div id={styles["date1"]}>February 11, 2024</div>
            </div>
          </section>
          <section className={styles.space}>
            <div className={styles.tagg}>
